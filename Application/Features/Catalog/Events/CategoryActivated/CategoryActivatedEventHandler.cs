...
namespace AE.Market.Application.Features.Catalog.Events.CategoryActivated;

internal sealed class CategoryActivatedEventHandler(
    ICacheService cache
) : INotificationHandler<DomainEventNotification<CategoryActivatedDomainEvent>>
{
    public async Task Handle(
        DomainEventNotification<CategoryActivatedDomainEvent> notification,
